...
@section('action-button')
    <a href="{{ route('timesheet.export') }}" class="buttongreen" data-bs-toggle="tooltip"
    ...
    <a href="#" data-url="{{ route('timesheet.file.import') }}" data-ajax-popup="true"
        ...
        class="buttongreen" data-bs-original-title="{{ __('Import') }}">
    ...
    @can('Create TimeSheet')
        <a href="#" data-url="{{ route('timesheet.create') }}" data-ajax-popup="true" data-size="md"
            ...
            class="buttongreen" data-bs-original-title="{{ __('Create') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            <a href="{{ route('timesheet.index') }}" class="btn btn-sm buttondanger" data-bs-toggle="tooltip"
                            ...
                            <div class="col-auto">
                                <div class="row">
                                    <div class="col-auto mt-4">
                                        ...
                                        <a href="{{ route('timesheet.index') }}" class=" buttondanger"
