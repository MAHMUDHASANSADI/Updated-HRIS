<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(' Type')): ?>
            <a href="<?php echo e(route('accounttype.index')); ?>"
                class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('accounttype*') ? 'active' : ''); ?>"><?php echo e(__(' Type')); ?>
...
<?php /**PATH D:\laragon\www\HRM\resources\views/layouts/hrm_setup.blade.php ENDPATH**/ ?>