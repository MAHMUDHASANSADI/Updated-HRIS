<?php echo e(Form::open(['route' => 'custom_page.store', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            ...
            <?php echo e(Form::text('menubar_page_name', null, ['class' => 'form-control font-style', 'placeholder' => __('Enter Page Name'), 'required' => 'required'])); ?>
...
<?php /**PATH D:\laragon\www\HRM\Modules/LandingPage\Resources/views/landingpage/menubar/create.blade.php ENDPATH**/ ?>